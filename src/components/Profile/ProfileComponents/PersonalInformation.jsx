    ...
    <div className="flex flex-col gap-2 w-full">
      <div className="flex justify-between items-center w-full text-[#FFFFFF] font-baloo2">
        ...
        <div className="flex gap-4">
          {!isEditing && (
            <button className="bg-[linear-gradient(0deg,rgba(84,32,164,0.1),rgba(84,32,164,0.1)),linear-gradient(180deg,rgba(255,255,255,0.02)_0%,rgba(255,255,255,0.1)_100%)] py-2 px-4 rounded-lg shadow-[0px_10px_10px_#0000001A,0px_4px_4px_#0000000D,0px_1px_0px_#0000000D] backdrop-blur-[20px]">
              Change password
            </button>
          )}
          <button
